# Publish Pocket Budget Version 26 with GitHub Pages

1. Extract the ZIP file on your Windows computer.
2. Open your existing `pocket-budget` GitHub repository.
3. Upload all replacement files to the repository root. Upload the complete Version 26 project or the listed replacement files from the update package.
...
Version 26 uses this service-worker cache:
